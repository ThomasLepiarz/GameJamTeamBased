...
{
    public class TransitionLeft : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        private string _eventDataString; //will be the Button that triggers the event as a string
        private string buttonPosition;

        //properties to be called by the GameManager
        //(Script TransitionButtonHandler)
        public string ButtonPosition { get => buttonPosition; private set => buttonPosition = value; }
